...
function _init()
	...
	for k in all(moves_data) do
		perfect_moves += k[1] -- if level completed perfectly
...
function game_win()
	...
	if moves >= initial_moves - perfect_moves then
		print("perfect!", 32, 80, 7)
	end
	print("moves left "..tostr(moves), 32, 88, 7)
	win = true
end
...
function check_current_cell()
	...
	if x/8 == socky_pos[level][1] and y/8 == socky_pos[level][2] and socky_collect == false then
		...
		socky_add = max(moves_data[level][2] - moves_data[level][1] + 10, 0) -- extra temporary socky boost
		moves += socky_add
		unfog_start()
	end
...
function get_level_data()
	level_bg = 3
	goal_height = {7, 9, 5, 10} -- cells from top of screen, base 0
	fog_height = {7, 6, 1, 1} -- cells from top of screen, base 0. must be >= 1
	...
	moves_data = {
		...
		-- [2] number of moves needed with socky
		-- [3] number of moves allowed for each level
		{35, 45, 40},
		{30, 62, 35},
...

...

...
__gff__

__map__

